...
EditorUi.prototype.createUi = function()
{
	if(mxClient.IS_VIEW){
		...
		// Creates the treelist
		this.sidebar = (this.editor.chromeless) ? null : this.createTreeList(this.sidebarContainer);
		if (this.sidebar != null)
		{
			this.container.appendChild(this.sidebarContainer);
		}
		
		// Creates the attribute panel
		this.format = (this.editor.chromeless || !this.formatEnabled) ? null : this.createAttriPanel(this.formatContainer);
		if (this.format != null)
		{
...
/**
 * Creates a new treelist for the given container.
 */
EditorUi.prototype.createTreeList = function(container)
{
	return new TreeList(this, container);
};
...
/**
 * Creates a new AttriPanel for the given container.
 */
EditorUi.prototype.createAttriPanel = function(container)
{
	return new AttriPanel(this, container);
};
